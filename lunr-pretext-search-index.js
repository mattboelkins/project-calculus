...
},
{
  ...
  "number": "1.3.2",
  "title": "",
  "body": " This worked example demonstrates how to apply the limit definition of the derivative to a quadratic function. A draft of the text and images can be found in this Google document .  "
},
{
...
{
  "id": "sec-deriv-pt-subsection-BC-12-1",
  "level": "2",
  "url": "sec-deriv-pt.html#sec-deriv-pt-subsection-BC-12-1",
  "type": "Table",
  "number": "1.3.4",
...
},
{
  ...
  "type": "Checkpoint",
  "number": "1.3.13",
  "title": "Clicker Question 1: the difference quotient of a linear function.",
  "body": "Clicker Question 1: the difference quotient of a linear function  Consider a function . Which of the following statements is true about the quantity ?      , for     That's incorrect.           That's incorrect.       , for     That's correct.       , for     That's incorrect.    "
},
{
  "id": "DC-Act1-CQ2",
  "level": "2",
  ...
  "type": "Checkpoint",
  "number": "1.3.14",
  "title": "Clicker Question 2: rates of change of a linear function.",
  "body": "Clicker Question 2: rates of change of a linear function  Let . Consider the following statements.     The average rate of change of on the interval is .    The slope of the secant line between the points and is .    The instantaneous rate of change of at is .     .     Which of the following statements is true?     Only (2) is true.    That's incorrect.      Only (1) and (2) are true.    That's incorrect.      Only (3) and (4) are true.    That's incorrect.      All of (1), (2), (3), and (4) are true.    That's correct.    "
},
{
...
},
{
  ...
  "type": "Checkpoint",
  "number": "1.3.15",
  "title": "Clicker Question 3: the derivative of <span class=\"process-math\">\\(g(x) = |x|\\)<\/span> at different values.",
  "body": "Clicker Question 3: the derivative of at different values  Let . Recall that if , then , and if , then . Consider the following statements.   and    and   If , then , and if , then   If , then , and if , then        Only (1) is true    That's incorrect.      Only (1) and (3) are true    That's correct.      None of (1), (2), (3), or (4) are true.    That's incorrect.      Only (2) and (4) are true    That's incorrect.    "
},
{
  "id": "DC-Act1-CQ4",
  "level": "2",
  ...
  "type": "Checkpoint",
  "number": "1.3.16",
  "title": "Clicker Question 4: the derivative of <span class=\"process-math\">\\(g(x)=|x|\\)<\/span> at <span class=\"process-math\">\\(x = 0\\)<\/span>.",
  "body": "Clicker Question 4: the derivative of at  For , the limit definition of the derivative shows that . Which of the following statements is true?          That's incorrect.           That's incorrect.           That's incorrect.       does not exist    That's correct.    "
},
{
  "id": "sec-deriv-pt-4-3-6-1-2-2",
  "level": "2",
  "url": "sec-deriv-pt.html#sec-deriv-pt-4-3-6-1-2-2",
  "type": "Figure",
  "number": "1.3.17",
  "title": "",
...
},
{
  ...
  "type": "Checkpoint",
  "number": "1.3.18",
  "title": "Clicker Question 5: applying the limit definition to a quadratic function.",
  "body": "Clicker Question 5: applying the limit definition to a quadratic function  Let . Write down all of the steps required to apply the limit definition of the derivative to determine . [Nothing else appears on the screen until the instructor presses NEXT .]  Consider the following statements that correspond to the process of applying the limit definition of the derivative:                Which of the following statements is true?     Only (1).    That's incorrect.      Only (4).    That's incorrect.      (1) and (3)    That's correct.      (2) and (4)    That's incorrect.    "
},
{
  "id": "DC-Act1-CQ6",
  "level": "2",
  ...
  "type": "Checkpoint",
  "number": "1.3.19",
  "title": "Clicker Question 6: applying the limit definition to a rational function.",
  "body": "Clicker Question 6: applying the limit definition to a rational function  Let . Write down all of the steps required to apply the limit definition of the derivative to determine . [Nothing else appears on the screen until the instructor presses NEXT .]  Consider the following statements that correspond to the process of applying the limit definition of the derivative:                Which of the following statements is true?     Only (2)    That's incorrect      Only (3)    That's incorrect.      Only (1) and (3)    That's incorrect.      (1), (3), and (4)    That's correct.    "
},
{
...
},
{
  ...
  "type": "Exercise",
  "number": "1.3.3.5",
  "title": "Matching meaning to numerical values.",
  "body": "Matching meaning to numerical values  Let be given by the following graph.   Plot of and some of its tangent lines.    Match each expression with its meaning.   Think about each of quantities corresponding to a slope on the graph.    The instantaneous rate of change of when         The average rate of change of on the interval     The slope of the tangent line to at the point where     The average rate of change of on the interval     The slope of the secant line between the points and    "
},
{
...
},
{
  ...
  "number": "1.3.3.1",
  "title": "",
  "body": " First assessment exercise  "
},
{
  "id": "sec-deriv-fxn",
  "level": "1",
