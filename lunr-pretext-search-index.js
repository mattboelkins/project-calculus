...
{
  "id": "sec-deriv-pt-review",
  "level": "2",
  "url": "sec-deriv-pt.html#sec-deriv-pt-review",
  "type": "Exploration",
  "number": "1.3.1",
  "title": "",
  "body": " In Section 1.1, we learned how the average velocity of a moving object, such as a car driving on a straight road, is determined by the quantity . More generally, the average rate of change of a function from to is given by . For example, if , The average rate of change of a function is important because it provides information about how a function is changing.  Learning objectives for this activity    compute the average rate of change of a function on a given interval    interpret the average rate of change as the slope of a secant line (and vice versa)       "
},
{
  "id": "review-MC1",
  "level": "2",
  "url": "sec-deriv-pt.html#review-MC1",
  "type": "Checkpoint",
  "number": "1.3.1.1",
  "title": "Q1: computing the average rate of change from a formula.",
  "body": "Q1: computing the average rate of change from a formula  Let . Then          That's incorrect. But is an important part of computing .           That's incorrect. But is an important part of computing .           That’s correct since .           That’s incorrect. But is an important part of computing .    "
},
{
  "id": "review-MC2",
  "level": "2",
  "url": "sec-deriv-pt.html#review-MC2",
  "type": "Checkpoint",
  "number": "1.3.1.2",
  "title": "Q2: computing the average rate of change from a graph.",
  "body": "Q2: computing the average rate of change from a graph  Let be the function given by the following graph.   Which of the following statements is true?          That's incorrect. But is an important part of computing .           That's incorrect. But is an important part of computing .           That’s correct since .           That’s incorrect. But is an important part of computing .    "
},
{
  "id": "sec-deriv-pt-BA1",
  "level": "2",
  ...
  "number": "1.3.2",
  "title": "",
  "body": " This beginning activity introduces the limit definition of the derivative using an animation with embedded questions. A draft of the text and images can be found in this Google document , along with a prototype animation that has several embedded questions for students.  Learning objectives for this activity   understand each of the components of the limit definition of the derivative: , , , , , and the limit itself  understand that the tangent line is a limit of secant lines  interpret the derivative's value as the slope of the tangent line to the curve, as well as the function's instantaneous rate of change at the fixed -value    .  "
},
{
  "id": "sec-deriv-pt-subsection-BC-10",
  "level": "2",
  "url": "sec-deriv-pt.html#sec-deriv-pt-subsection-BC-10",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "sec-deriv-pt-subsection-BC-11-2",
  "level": "2",
  "url": "sec-deriv-pt.html#sec-deriv-pt-subsection-BC-11-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "assemblage "
},
{
  ...
  "number": "1.3.3",
  "title": "",
  "body": " This worked example demonstrates how to apply the limit definition of the derivative to a quadratic function. A draft of the text and images can be found in these Google slides .  Learning objectives for this activity    apply a quadratic function formula to determine and   use algebra to simplify the difference quotient  use and apply limit notation to determine the derivative value at a fixed location  interpret the meaning of the derivative's value    .  "
},
{
  "id": "BA2-Q1",
  "level": "2",
  "url": "sec-deriv-pt.html#BA2-Q1",
  "type": "Checkpoint",
  "number": "1.3.1.3",
  "title": "Interpreting the slope of the tangent line to a curve.",
  "body": "Interpreting the slope of the tangent line to a curve  Let be the function given by the following graph.   Which of the following statements is true?      is positive.    That's incorrect. Remember that measures the slope of the tangent line to at the point .       .    That's incorrect. If , then the graph would have a horizontal tangent line (with slope ) at .       is negative.    That’s correct since measures the slope of the tangent line to at the point ; since the tangent line at falls from left to right, its slope is negative, and thus so is the value of .    "
},
{
...
{
  "id": "sec-deriv-pt-subsection-BC-17-2",
  "level": "2",
  "url": "sec-deriv-pt.html#sec-deriv-pt-subsection-BC-17-2",
  "type": "Table",
  "number": "1.3.1.6",
  "title": "Summary of Exploration 1.3.3: finding <span class=\"process-math\">\\(f'(2)\\)<\/span> for <span class=\"process-math\">\\(f(x) = x - x^2\\text{.}\\)<\/span>",
...
},
{
  ...
  "number": "1.3.4",
  "title": "",
  "body": " This guided example leads students to apply the limit definition of the derivative to a rational function. A draft of the text and images for the animation\/video can be found in this Google document .  Learning objectives for this activity   apply a rational function formula to determine and   use algebra to simplify the difference quotient, including finding a common denominator  use and apply limit notation to determine the derivative value at a fixed location   .   Mock-up video for animation    "
},
{
  "id": "BA3-fillin1",
  "level": "2",
...
{
  "id": "sec-deriv-pt-H1-2",
  "level": "2",
  "url": "sec-deriv-pt.html#sec-deriv-pt-H1-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "sec-deriv-pt-5-7-1-2-2",
  "level": "2",
  "url": "sec-deriv-pt.html#sec-deriv-pt-5-7-1-2-2",
  "type": "Figure",
  "number": "1.3.3.3",
  "title": "",
...
{
  "id": "ex-deriv-pt-assess-3",
  "level": "2",
  "url": "sec-deriv-pt.html#ex-deriv-pt-assess-3",
  "type": "Exercise",
  "number": "1.3.5.1",
...
{
  "id": "ex-deriv-pt-assess-4",
  "level": "2",
  "url": "sec-deriv-pt.html#ex-deriv-pt-assess-4",
  "type": "Exercise",
  "number": "1.3.5.2",
  "title": "Applying the limit definition of the derivative to compute exact derivative values.",
  "body": "Applying the limit definition of the derivative to compute exact derivative values "
},
{
  "id": "ex-deriv-pt-assess-5",
  "level": "2",
  "url": "sec-deriv-pt.html#ex-deriv-pt-assess-5",
  "type": "Exercise",
  "number": "1.3.5.3",
  "title": "Applying the limit definition of the derivative to estimate derivative values.",
  "body": "Applying the limit definition of the derivative to estimate derivative values "
},
{
  "id": "ex-deriv-pt-assess-6",
  "level": "2",
  "url": "sec-deriv-pt.html#ex-deriv-pt-assess-6",
  "type": "Exercise",
  "number": "1.3.5.4",
  "title": "Interpreting function and derivative values from a graph that includes the tangent line.",
  "body": "Interpreting function and derivative values from a graph that includes the tangent line "
},
{
  "id": "sec-deriv-fxn",
  "level": "1",
